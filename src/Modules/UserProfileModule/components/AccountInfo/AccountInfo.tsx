...
export default function AccountInfo() {
  ...
  return (
    <>
      <section>
        <div
          className={`text-theme d-flex justify-content-center pb-5 align-items-center `}
        >
          <table className="table table-bordered">
            <tbody>
              <tr>
                ...
                <td className="bg-theme text-theme">{currentUser?.userName}</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td className="bg-theme text-theme">{currentUser?.country}</td>
              </tr>
              <tr>
                <th className="bg-theme text-theme" scope="row">
                  joined on
