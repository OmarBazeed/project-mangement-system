			...
			<section>
					...
					<Modal.Body>
						<div>
							...
							<p>
								...
								<span className="fw-bold">Tasks No.: </span>
					...
					<div className="row">
						<div className="col-md-9 inputSearch">
							<input
								...
								className={`form-control ps-5 p-3 rounded-5 ${style.filterInput}`}
								onChange={(e) => {
				...
				<div className="container my-3 w-100">
					<nav aria-label="Page navigation example w-100">
						<ul className="flex-wrap pagination w-100 d-flex align-items-center justify-content-center">
